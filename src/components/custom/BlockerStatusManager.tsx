        ...
        <DialogHeader>
          <div className="flex items-center gap-3 mb-2">
            ...
            <DialogTitle className="text-xl font-bold text-slate-900">
              {isBlocked ? 'Work Status - Blocked' : 'Report Work Blockage'}
            </DialogTitle>
          </div>
          <DialogDescription className="text-slate-600">
            {isBlocked 
              ? 'This work is currently blocked. You can remove the blockage or update the reason.'
          ...
          {isBlocked && blockerRemark && (
            <div className="p-4 bg-gradient-to-r from-red-50 to-pink-50 rounded-xl border border-red-200">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-medium text-red-800">Current Blockage Reason:</span>
              </div>
